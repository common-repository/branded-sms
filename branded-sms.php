<?php
/*
Plugin Name: Branded SMS
Version: 4.4.3
Plugin URI: https://hostandsoft.com/branded-sms-pakistan/
...
if ( is_plugin_active( 'woocommerce/woocommerce.php' ) || is_network_only_plugin( 'woocommerce/woocommerce.php' ) ) {
	...
	function apg_sms_admin_menu() {
		add_submenu_page( 'woocommerce', __( 'Host & Soft Branded SMS', 'branded-sms' ),  __( 'SMS Notifications', 'branded-sms' ) , 'manage_woocommerce', 'apg_sms', 'apg_sms_tab' );
	}
...
function apg_sms_requiere_wc() {
	...
	echo '<div class="error fade" id="message"><h3>' . $apg_sms['plugin'] . '</h3><h4>' . __( "This plugin require WooCommerce active to run!", 'branded-sms' ) . '</h4></div>';
